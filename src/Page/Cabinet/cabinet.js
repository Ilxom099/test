    ...
    return (
        <div id={'home'}>
            ...
            <Container>
                ...
                <Content>
                    ...
                    <Variant>
                        ...
                        <Box htmlFor={'i20'} onClick={()=>setTest3(false)}>
                            ...
                            <label> B) {'<input type="checked">'} </label>
                        </Box>
                ...
                <Content>
                    <Question>
                        <h3> 4. Display paramaetri Block bolgan elementlarni belgilang  ? </h3>
                    </Question>
                    <Variant>
                ...
                <Content>
                    <Question>
                        <h3> 7. Biror bir elementga position absolute berilsa default holda qaysi element uni otasi hisoblanadi ?   </h3>
                    </Question>
                    <Variant>
                ...
                <Content>
                    <Question>
                        <h3> 18. Animation yozish uchun qanday kalit so'z kerak bo'ladi?  </h3>
                    </Question>
                    <Variant>
                ...
                <Content>
                    <Question>
                        <h3> 21. Gradient rang berishni nechta turi  bor ?  </h3>
                    </Question>
                    <Variant>
                ...
                <Content>
                    <Question>
                        <h3> 24. Harflarni orasini ochadigan kodni toping ? </h3>
                    </Question>
                    <Variant>
                ...
                <Content>
                    <Question>
                        <h3> 28. Shrift ulash uchun qaysi kalit so'z kerak  </h3>
                    </Question>
                    <Variant>
                ...
                <Content>
                    <Question>
                        <h3> 29. Transition-delay qanday vazifani bajaradi ? </h3>
                    </Question>
                    <Variant>
                        <Box htmlFor={'x4'} onClick={()=>setTest29(false)}>
                            <input type="radio" id={'x4'} name={'input29'}/>
                            <label> A)  Element boshqa qiymatga o'tish uchun tezlik qo'shni bajaradi   </label>
                        </Box>
                        <Box htmlFor={'x5'} onClick={()=>setTest29(true)} className={`${dis ? 'success' : ''}`}>
                            <input type="radio" id={'x5'} name={'input29'}/>
                            <label> B) Element boshqa qiymatga o'tish uchun kutish vaqtini bajaradi  </label>
                        </Box>
                        <Box htmlFor={'x6'} onClick={()=>setTest29(false)}>
                            <input type="radio" id={'x6'} name={'input29'}/>
                            <label> C)  Element boshqa qiymatga o'tganda animatsiya ishlashi uchun   </label>
                        </Box>
